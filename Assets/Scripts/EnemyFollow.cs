   ...
   public override void OnEnable()
    {
        ...
        isFollowing = true;
        SoundManager.instance.Play("ghast_appear");
    }
    public override void TakeDamage()
    {
        SoundManager.instance.Play("ghast_damage");
    ...
    {
        SoundManager.instance.Play("ghast_die");
          isFollowing = false;
          base.Die();
    }
    private void Update()
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            SoundManager.instance.Play("ghast_attack");
